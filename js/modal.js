(() => {
	...
	document.querySelector(".order-button").addEventListener("click", toggleOrderServiceModal);
	document.querySelector(".modal-close").addEventListener("click", toggleOrderServiceModal);
